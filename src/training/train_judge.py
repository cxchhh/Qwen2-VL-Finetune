...
from training.data import make_supervised_judge_data_module
from training.params import JudgeDataArguments, ModelArguments, TrainingArguments
...
def train():
    ...
    parser = HfArgumentParser(
        (ModelArguments, JudgeDataArguments, TrainingArguments))
    ...
    data_module = make_supervised_judge_data_module(model_id=model_args.model_id,
                                              processor=processor,
                                              data_args=data_args)
